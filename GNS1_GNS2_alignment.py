...
for chip1 in range(1,5,3):
    ...
    deg_t = 1
    max_deg = 4
    d_m = .7#!!! max distance for the fine alignment betwenn GNS1 and 2
    d_m_pm = 1#!!! max distance for the proper motions
    align_by = 'Polywarp'#!!!
    # align_by = '2DPoly'#!!!
    # f_mode = 'W'
    f_mode = 'WnC'
    ...
    gns1_pm['pmx'] = pm_x
    gns1_pm['pmy'] = pm_y
    gns1_pm['ra2'] = gns2['ra2'][l_12['ind_2']]
    gns1_pm['Dec2'] = gns2['Dec2'][l_12['ind_2']]
